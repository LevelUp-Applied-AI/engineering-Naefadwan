...
Answer:Cohort 2024A had the highest average pre-work score at 81.8, compared to 79.5 (2024B) and 75.5 (2025A). This suggests that 2024A may have entered the program with stronger prerequisite preparation overall.
...
Answer:There are 8 students who scored 80 or above. Most of the high scorers are from Jordan, but strong performers also appear from Egypt and Palestine, showing that high performance is distributed across multiple countries.
...
Answer:Lina Barakat submitted all three projects on time with very high grades (98, 95, 96), showing strong consistency and high engagement with the coursework.